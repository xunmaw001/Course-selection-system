...
import center from '@/views/center'
    ...
    import liuyanzixun from '@/views/modules/liuyanzixun/list'
    import kemumingcheng from '@/views/modules/kemumingcheng/list'
...
const routes = [{
	...
	path: '/liuyanzixun',
        name: '留言咨询',
        component: liuyanzixun
      }
      ,{
	path: '/kemumingcheng',
        name: '科目名称',
        component: kemumingcheng
      }
    ]
  },
  {
