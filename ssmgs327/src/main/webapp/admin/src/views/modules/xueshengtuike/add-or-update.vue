<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="退课时间" prop="tuikeshijian">
            <el-date-picker
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.tuikeshijian" label="退课时间" prop="tuikeshijian">
              <el-input v-model="ruleForm.tuikeshijian" 
                placeholder="退课时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="退课原因" prop="tuikeyuanyin">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.tuikeyuanyin" label="退课原因" prop="tuikeyuanyin">
                    <span v-html="ruleForm.tuikeyuanyin"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.tuikeyuanyin = this.ruleForm.tuikeyuanyin.replace(reg,'../../../ssmgs327/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
